...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "আহ সোনা আমার, তোমার অলিতে গলিতে উম্মাহ😇😘",
          "কি গো সোনা, আমাকে ডাকছো কেনো?",
          "বার বার আমাকে ডাকস কেন😡",
          "আহ শোনা আমার, আমাকে এতো ডাকতেছো কেনো, আসো বুকে আসো🥱",
          "হুম জান তোমার ওইখানে উম্মমাহ😷😘",
          "আসসালামু আলাইকুম, বলেন আপনার জন্য কি করতে পারি",
          "এতো sakib sakib না করে আমার সাকিব ভাইকে একটা গফ দে🙄",
          "আমার বসের আইডি, m.me/Sakib.Bhai.4x",
          "🍹এই নাও জুস খাও, sakib sakib করতে করতে তো হাপিয়ে গেছো🐸",
          "আমার বসকে মেসেজ দে, m.me/Sakib.Bhai.4x",
          "তোকে মারার প্লান করতেছি🐸",
          "বলো জানু😘"
        ];
